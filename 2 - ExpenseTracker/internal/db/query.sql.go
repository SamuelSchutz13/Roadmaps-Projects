...
VALUES ($1, $2) RETURNING id, description, amount, created_at
`
...
SELECT id, description, amount, created_at FROM expense WHERE id = $1 LIMIT 1
`
...
SELECT id, description, amount, created_at FROM expense ORDER BY amount
`
